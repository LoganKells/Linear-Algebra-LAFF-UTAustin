...
fprintf("TRMV_UT_UNB_VAR2 - See LAFF figure 4.3 (http://www.ulaff.net).\n");

% TRMV_UT_UNB_VAR2 = [TR]iangular [M]atrix-[V]ector multiply, 
...
% Created by: Logan Kells
  ...
  while ( size( UBR, 1 ) < size( U, 1 ) )
    ...
    % triangular matrix.
    % Pre-transpose u12t from row vector to column vector format.
    u12 = laff_copy(u12t, x2);
    % Calculate the matrix-vector multiplication.
    x2 = laff_scal(chi1, u12) + x2;
