...
% TRTRMM_UNB_VAR1 = [TR]iangle [TR]iangle [M]atrix [M]ultiplication 
% [UNB]locked [VAR]iant [1].

% ------------------------------------------------------------------------
% UT Austin Linear Algebra: Foundations to Frontiers (http://www.ulaff.net)
% LAFF Homework 5.5.1.10
% Date: 12/13/2020
% Created by: Logan Kells

fprintf("LAFF Homework 5.5.1.10\n");
fprintf("GEMM_UNB_VAR2 - See LAFF figure in Homework 5.5.1.10 (http://www.ulaff.net).\n");
